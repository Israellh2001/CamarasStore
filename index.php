...
<html lang="en">
    ...
    <body>
      ...
      $empleadosTable = "Create table if not exists Empleados (Id int, primary key (Id), Name varchar (25), Dir varchar (25), Tel int, Mail varchar (25), Sex varchar (25), Nacimiento varchar(40), Turn varchar (25), Salary double, Ingreso varchar (40), Charge varchar (25))";
      $products = "Create table if not exists Productos(Id int, primary key (Id), Name varchar(25), Brand varchar (40), Descr varchar (900), Exist int, precioMay double, precioMen double, Type varchar(25));";
